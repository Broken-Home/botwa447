...
const daftar3 = [{buttonId: `verify`,buttonText: {displayText: `🏷️DAFTAR🏷️ `,},type: 1,},]
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© Unknown_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('empty')
}
...
🏴‍☠️───「 \`\`\`INFO BOT\`\`\` 」
│
🏴‍☠️ _Nama Bot : Unknown Bot Assistan_
...
│
└───「 \`\`\`Unknown Bot Assistan\`\`\` 」`
sendButLocation(from, `${menu}`, "*_© Unknown Bot Assistan_*", {jpegThumbnail:ofrply,name:""}, [{buttonId:`command`,buttonText:{displayText:'BUTTON MENU'},type:1},{buttonId:`owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`script`,buttonText:{displayText:'SOURCE CODE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'allmenu': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
imageMessage: mhan.message.imageMessage,
contentText: `${menunya}`,
footerText: `Unknown Bot Assistan`,
buttons: gbutsan,
headerType: 4
}
...
case 'command':
 ...
 footerText: '*_© Unknown Bot Assistan_*',
...
ini_list.push({
"displayName": `Developer Unknown Bot Assistan`,
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `Unknown Bot Assistan`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script Unknown Bot Assistan`,
          "url": "Mau nyolong yaa!!!"
        },
        "index": 0
      }
		    ...
		    kurr.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), MessageType.sticker, {quoted: mek})
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                ...
                break
					case 'restart':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
reply(`_Restarting Unknown Bot Assistan_`)
exec(`cd &&  node index`)
sleep(4000)
reply('Sukses')
break
...
buttons = [{buttonId: `menu`, buttonText: {displayText: '🏴‍☠️MENU🏴‍☠️'}, type: 1},{buttonId: `owner`, buttonText: {displayText: '☄️OWNER☄️'}, type: 1}]
const btnbc = {
    contentText: `${body.slice(4)}`,
    footerText: '*_NUMPANG LEWAT_*',
    buttons: buttons,
    headerType: 1
}
			...
			case 'tagme':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                  var nomqm = mek.participant
					...
					break
				case 'join': 
              reply('PUNYA TANGAN KAN MANUAL LAH GBLK!!!')
              break
				case 'totag':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
			if (!isGroup) return reply(mess.only.group)
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              kurr.groupUpdateSubject(from, `HACKED BY Unknown Bot Assistan`)
...
for (let i = 0; i < args[0]; i++) {
kurr.sendMessage(from, `Unknown Bot Assistan`, MessageType.extendedText,{
 quoted: {
key: {
...
kurr.sendMessage(from, `Unknown Bot Assistan`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
 ...
 quoted: {
  ...
  message: {
   orderMessage: {
    ...
    surface: 1,
    message: `${NamaOwner}`,
    orderTitle: `Unknown Bot Assistan`, // 
    sellerJid: '0@s.whatsapp.net' // Seller
   }
  }
 }
